...
public class Data {
    ...
    public static final String INVALID_LOGIN_VALUE = "LOGIN2";
    public static final String INVALID_PASSWORD_VALUE = "PASSWORD2";
    public static final String SQL_OR_1_IS_1 = "' OR '1'='1";
    public static final String XSS_SCRIPT_ALERT = "<script>alert('XSS')</script>";
    ...
    public static final String CONTROL_PANEL_TEXT = "Control panel";
